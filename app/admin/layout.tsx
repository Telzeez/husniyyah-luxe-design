...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  try {
          ...
          <div className="h-16 flex items-center px-6 border-b border-brand-gold/20">
            <Link href="/" className="flex items-center space-x-2 group">
              <div className="relative w-8 h-8 rounded-full overflow-hidden border border-brand-gold">
                <Image src="/logo.png" alt="Husniyyah Logo" fill sizes="32px" className="object-cover" />
              </div>
    ...
    return <div className="p-8 text-red-500 font-bold">FATAL LAYOUT ERROR: {err.message}</div>;
  }
}
