    ...
    <FavoriteProvider>
      <CartProvider>
        <div className="min-h-screen bg-background text-foreground font-sans flex flex-col transition-colors duration-300">
          ...
          {/* Header */}
          <header className="border-b border-brand-gold/20 py-4 md:py-6 px-4 md:px-8 sticky top-0 bg-background/90 backdrop-blur-md z-50 transition-colors duration-300 relative">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              ...
              <div className="flex-shrink-0 flex items-center space-x-3">
                <Link href="/" className="flex items-center space-x-2 md:space-x-3 group">
                  <div className="relative w-8 h-8 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-transparent group-hover:border-brand-gold transition-colors">
                    <Image src="/logo.png" alt="Husniyyah Logo" fill sizes="100vw" className="object-cover" />
                  </div>
                  <span className="text-lg md:text-xl font-bold tracking-[0.2em] text-foreground">
                    HUSNIYYAH
                  </span>
                </Link>
              </div>
              ...
              <div className="flex items-center space-x-2 md:space-x-4 text-foreground/80">
                <div className="hidden md:block"><ThemeToggle /></div>
                
                <Link href="/client" aria-label="Account" className="hover:text-brand-gold transition-colors border border-foreground/20 p-2 rounded-sm hover:border-brand-gold hidden md:flex">
